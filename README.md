...
Retreivr is now available as a docker package under the new repo and is PACKED with amazing new features that really define what this project will be going forward.

This repo will be set to Archive and not maintained.
